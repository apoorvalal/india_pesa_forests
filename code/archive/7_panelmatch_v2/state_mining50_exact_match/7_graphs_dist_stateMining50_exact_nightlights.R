...
# Generating plot
png(file = file.path( outsg_state_mining50_exact_match , "fig5_nl_p95.png"), 
...
#% Generating Plot
png(file = file.path( outsg_state_mining50_exact_match , "fig4_nl_p95.png") , 
...
# Saving Plot
ggsave(file.path( outsg_state_mining50_exact_match, "fig7_nl_p95.png"), 
       f2, device = png, 
