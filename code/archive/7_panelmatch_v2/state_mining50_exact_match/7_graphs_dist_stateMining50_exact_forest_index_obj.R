...
load( file.path( state_mining_exact_match, "panelmatch_cbps_vcf_forest_index.RData" ) )
load( file.path( state_mining_exact_match, "panelmatch_ps_vcf_forest_index.RData" ) )
load( file.path( state_mining_exact_match, "panelmatch_none_vcf_forest_index.RData" ) )
...
save(balance_nomatch, 
     ...
     balance_ps, 
     balance_cbps,
     file = file.path(state_mining_exact_match, 
                      "fig5_stateMining_exact_forest_index_obj.RData"))
...
save(compared, 
     ...
     refined_balance, 
     non_refined_balance,
     file = file.path( state_mining_exact_match, "fig4_stateMining_exact_forest_index_obj.RData" ) )
...
save(ps_results_vcf, 
     cbps_results_vcf,
     df_aux1,
     file = file.path( state_mining_exact_match, "fig7_stateMining_exact_forest_index_obj.RData" ) )
