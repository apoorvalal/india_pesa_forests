...
load( file.path( state_mining_exact_match, "panelmatch_cbps_vcf_nl_p95.RData" ) )
load( file.path( state_mining_exact_match, "panelmatch_ps_vcf_nl_p95.RData" ) )
...
save_obj_path <- file.path( state_mining_exact_match, 
                            "fig5_stateMining_exact_nl_p95_obj.RData" )
...
# Generating Objects for the plot
...
# Save objects for plot
save_obj_path <- file.path( state_mining_exact_match, 
                            "fig4_stateMining_exact_nl_p95_obj.RData" )
...
# Save objects for plot
save_obj_path <- file.path( state_mining_exact_match, 
                            "fig7_stateMining_exact_nl_p95_obj.RData" )
save( ps_results_vcf, 
      cbps_results_vcf, 
      df_aux1, 
      file = save_obj_path )
