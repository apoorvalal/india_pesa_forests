...
outsg_match <- file.path(root, "out_sg/7_panelmatch_v2/state_mining50_exact_match")
...
load( file.path( state_mining_exact_match, "fig7_stateMining_exact_forest_index_obj.RData" ) )
load( file.path( state_mining_exact_match, "fig5_stateMining_exact_forest_index_obj.RData" ) )
load( file.path( state_mining_exact_match, "fig4_stateMining_exact_forest_index_obj.RData" ) )
