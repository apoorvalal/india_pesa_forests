...
################################################################
# Matching nl_p95 Using CBPSCORE 4 Years
################################################################
match_cbps_vcf_nl_p95 = PanelMatch(
...
save(match_cbps_vcf_nl_p95,
     file = file.path(state_exact_match, "panelmatch_cbps_vcf_nl_p95.RData"))
