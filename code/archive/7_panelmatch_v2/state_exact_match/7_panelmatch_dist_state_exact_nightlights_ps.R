...
################################################################
# Matching nl_p95 Using PSCORE 4 Years
################################################################
tic()
match_ps_vcf_nl_p95 = PanelMatch(
...
save(match_ps_vcf_nl_p95,
     file = file.path(state_exact_match, "panelmatch_ps_vcf_nl_p95.RData"))
