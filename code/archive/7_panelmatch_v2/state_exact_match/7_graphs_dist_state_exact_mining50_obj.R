...
load( file.path( state_exact_match, "panelmatch_cbps_vcf_con_Mining50.RData" ) )
load( file.path( state_exact_match, "panelmatch_ps_vcf_con_Mining50.RData" ) )
...
balance_norefinement <- get_covariate_balance(matched.sets = match_ps_vcf_con_Mining50$att,
                                              data = df_match,
                                              covariates = cov_vars,
                                              use.equal.weights = TRUE)
...
save_obj_path <- file.path( state_exact_match, "fig5_state_exact_con_Mining50_obj.RData" )
...
# Save objects for plot
save_obj_path <- file.path( state_exact_match, "fig4_state_exact_con_Mining50_obj.RData" )
...
# Save objects for plot
save_obj_path <- file.path( state_exact_match, "fig7_state_exact_con_Mining50_obj.RData" )
save( ps_results_vcf, 
      cbps_results_vcf, 
      df_aux1,
      file = save_obj_path )
