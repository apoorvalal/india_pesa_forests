...
save(match_ps_vcf_con_Mining30,
     file = file.path(root, "tmp/panel_match_v2/state_exact_match/panelmatch_ps_vcf_con_Mining30.RData"))
...
save(match_cbps_vcf_con_Mining30,
     file = file.path(root, "tmp/panel_match_v2/state_exact_match/panelmatch_cbps_vcf_con_Mining30.RData"))

save(match_ps_vcf_con_Mining30, 
     match_cbps_vcf_con_Mining30,
     file = file.path(root, "tmp/panel_match_v2/state_exact_match/7_panelmatch_dist_state_exact_mining.RData"))
