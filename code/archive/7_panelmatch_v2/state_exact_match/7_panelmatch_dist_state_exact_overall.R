...
######################################################
names(df_final)
cols_use_match <- c("cellid", "year", "D", "num_state", 
                    "forest_index", "nl_p95", "con_Overall30",
                    "con_Overall30_4","con_Mining30_4",
                    "con_Forestry30_4", 
                    "con_Overall30_3", "con_Mining30_3",  
                    "con_Forestry30_3",
                    "con_Overall30_2","con_Mining30_2"  ,
                    "con_Forestry30_2", 
                    "con_Overall30_1", "con_Mining30_1" , 
                    "con_Forestry30_1"
                    )
...
################################################################
# Matching con_Overall30 Using PSCORE 4 Years
################################################################
# tic()
...
#      file = file.path(root, "tmp/panel_match_v2/state_exact_match/panelmatch_ps_vcf_con_Overall30.RData"))
# toc()
...
save(match_cbps_vcf_con_Overall30,
     file = file.path(root, "tmp/panel_match_v2/state_exact_match/panelmatch_cbps_vcf_con_Overall30.RData"))
# 
# save(match_ps_vcf_con_Overall30, 
#      match_cbps_vcf_con_Overall30,
#      file = file.path(root, "tmp/panel_match_v2/state_exact_match/panelmatch_cbps_vcf_con_Overall30.RData"))
toc()
################################################################
