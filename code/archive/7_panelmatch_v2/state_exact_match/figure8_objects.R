...
# Import data
########################################################################
load( file.path( state_exact_match_v2, "panelmatch_ps_vcf_con_Overall30.RData" ) )
load( file.path( state_exact_match_v2, "panelmatch_cbps_vcf_con_Overall30.RData" ) )
load( file.path( state_exact_match_v2, "panelmatch_ps_vcf_con_Forestry30.RData" ) )
load( file.path( state_exact_match_v2, "panelmatch_cbps_vcf_con_Forestry30.RData" ) )
load( file.path( state_exact_match_v2, "panelmatch_ps_vcf_con_Industry30.RData" ) )
load( file.path( state_exact_match_v2, "panelmatch_cbps_vcf_con_Industry30.RData" ) )
load( file.path( state_exact_match_v2, "panelmatch_ps_vcf_con_Infrastructure30.RData" ) )
load( file.path( state_exact_match_v2, "panelmatch_cbps_vcf_con_Infrastructure30.RData" ) )
load( file.path( state_exact_match_v2, "panelmatch_ps_vcf_con_LandUse30.RData" ) )
load( file.path( state_exact_match_v2, "panelmatch_cbps_vcf_con_LandUse30.RData" ) )
load( file.path( state_exact_match_v2, "panelmatch_ps_vcf_con_Mining30.RData" ) )
load( file.path( state_exact_match_v2, "panelmatch_cbps_vcf_con_Mining30.RData" ) )
load( file.path( state_exact_match_v2, "panelmatch_ps_vcf_con_Power30.RData" ) )
load( file.path( state_exact_match_v2, "panelmatch_cbps_vcf_con_Power30.RData" ) )
...
########################################################################
# Panel Estimate for Treatment Estimations
########################################################################
...
save( ps_results_vcf_con_Overall30, cbps_results_vcf_con_Overall30,
      ps_results_vcf_con_Forestry30, cbps_results_vcf_con_Forestry30,
      ps_results_vcf_con_Industry30, cbps_results_vcf_con_Industry30,
      ps_results_vcf_con_Infrastructure30, cbps_results_vcf_con_Infrastructure30,
      ps_results_vcf_con_LandUse30, cbps_results_vcf_con_LandUse30,
      ps_results_vcf_con_Mining30, cbps_results_vcf_con_Mining30,
      ps_results_vcf_con_Power30, cbps_results_vcf_con_Power30, 
      file = file.path( state_exact_match_v2, "figure8_objects.RData" ) )