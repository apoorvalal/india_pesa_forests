...
load( file.path( state_exact_match, 
                 "fig5_state_exact_con_Mining50_obj.RData" ) )
load( file.path( state_exact_match, 
                 "fig4_state_exact_con_Mining50_obj.RData" ) )
load( file.path( state_exact_match, 
                 "fig7_state_exact_con_Mining50_obj.RData" ) )
...
# Generating the plot
png(file = file.path( outsg_match, "fig5_con_Mining50.png"), 
...
# Generating the plot
png(file = file.path( outsg_match, "fig4_con_Mining50.png") , 
...
ggsave(file.path( outsg_match, "fig7_con_Mining50.png"), 
       f2, device = png, 
