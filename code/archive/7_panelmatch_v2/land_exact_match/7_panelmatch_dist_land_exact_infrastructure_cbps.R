...
land_exact_match <- file.path(tmp, "panel_match_v2/land_exact_match")
...
cols_use_match <- c("cellid", "year","con_Overall30_4",
                    "con_Mining30_4", "con_Overall30", 
                    "con_Mining30", "con_Forestry30",
                    ...
                    "con_Infrastructure30", "con_LandUse30", 
                    "con_Power30",
                    "nl_p95")
...
exact_match_vars <- c( "num_state", 
                       "con_Overall30_1", "con_Overall30_2", 
                       "con_Overall30_3", "con_Overall30_4",
                       "con_Mining30_1", "con_Mining30_2", 
                       "con_Mining30_3", "con_Mining30_4",
                       "con_Forestry30_1", "con_Forestry30_2", 
                       "con_Forestry30_3", "con_Forestry30_4")
...
################################################################
# Matching con_Infrastructure30 Using cbpsCORE 4 Years
################################################################
...
save(match_cbps_vcf_con_Infrastructure30,
     file = file.path(land_exact_match, "panelmatch_cbps_vcf_con_Infrastructure30.RData"))
