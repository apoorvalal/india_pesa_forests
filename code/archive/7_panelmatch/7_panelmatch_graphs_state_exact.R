...
# Import data
########################################################################
load( file.path( tmp, "state_exact_match/panelmatch_nomatch_vcf.RData" ) )
load( file.path( tmp, "state_exact_match/panelmatch_cbps_vcf.RData" ) )
load( file.path( tmp, "state_exact_match/panelmatch_ps_vcf.RData" ) )
load( file.path( tmp, "state_exact_match/panelmatch_none_vcf.RData" ) )
load( file.path( tmp, "state_exact_match/land_regdata.RData" ) )

load( file.path( tmp, "state_exact_match/panelmatch_ps_vcf_con_Overall30.RData" ) )
load( file.path( tmp, "state_exact_match/panelmatch_cbps_vcf_con_Overall30.RData" ) )
load( file.path( tmp, "state_exact_match/panelmatch_ps_vcf_con_Forestry30.RData" ) )
load( file.path( tmp, "state_exact_match/panelmatch_cbps_vcf_con_Forestry30.RData" ) )
load( file.path( tmp, "state_exact_match/panelmatch_ps_vcf_con_Industry30.RData" ) )
load( file.path( tmp, "state_exact_match/panelmatch_cbps_vcf_con_Industry30.RData" ) )
load( file.path( tmp, "state_exact_match/panelmatch_ps_vcf_con_Infrastructure30.RData" ) )
load( file.path( tmp, "state_exact_match/panelmatch_cbps_vcf_con_Infrastructure30.RData" ) )
load( file.path( tmp, "state_exact_match/panelmatch_ps_vcf_con_LandUse30.RData" ) )
load( file.path( tmp, "state_exact_match/panelmatch_cbps_vcf_con_LandUse30.RData" ) )
load( file.path( tmp, "state_exact_match/panelmatch_ps_vcf_con_Mining30.RData" ) )
load( file.path( tmp, "state_exact_match/panelmatch_cbps_vcf_con_Mining30.RData" ) )
load( file.path( tmp, "state_exact_match/panelmatch_ps_vcf_con_Power30.RData" ) )
load( file.path( tmp, "state_exact_match/panelmatch_cbps_vcf_con_Power30.RData" ) )
