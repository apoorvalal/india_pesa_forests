...
save(match_ps_vcf_con_Overall30,
     file = file.path(root, "tmp/state_exact_match/panelmatch_ps_vcf_con_Overall30.RData"))
...
save(match_cbps_vcf_con_Overall30,
     file = file.path(root, "tmp/state_exact_match/panelmatch_cbps_vcf_con_Overall30.RData"))
...
save(match_ps_vcf_con_Forestry30,
     file = file.path(root, "tmp/state_exact_match/panelmatch_ps_vcf_con_Forestry30.RData"))
...
save(match_cbps_vcf_con_Forestry30,
     file = file.path(root, "tmp/state_exact_match/panelmatch_cbps_vcf_con_Forestry30.RData"))
...
save(match_ps_vcf_con_Industry30,
     file = file.path(root, "tmp/state_exact_match/panelmatch_ps_vcf_con_Industry30.RData"))
...
save(match_cbps_vcf_con_Industry30,
     file = file.path(root, "tmp/state_exact_match/panelmatch_cbps_vcf_con_Industry30.RData"))
...
save(match_ps_vcf_con_Infrastructure30,
     file = file.path(root, "tmp/state_exact_match/panelmatch_ps_vcf_con_Infrastructure30.RData"))
...
save(match_cbps_vcf_con_Infrastructure30,
     file = file.path(root, "tmp/state_exact_match/panelmatch_cbps_vcf_con_Infrastructure30.RData"))
...
save(match_ps_vcf_con_LandUse30,
     file = file.path(root, "tmp/state_exact_match/panelmatch_ps_vcf_con_LandUse30.RData"))
...
save(match_cbps_vcf_con_LandUse30,
     file = file.path(root, "tmp/state_exact_match/panelmatch_cbps_vcf_con_LandUse30.RData"))
...
save(match_ps_vcf_con_Mining30,
     file = file.path(root, "tmp/state_exact_match/panelmatch_ps_vcf_con_Mining30.RData"))
...
save(match_cbps_vcf_con_Mining30,
     file = file.path(root, "tmp/state_exact_match/panelmatch_cbps_vcf_con_Mining30.RData"))
...
save(match_ps_vcf_con_Power30,
     file = file.path(root, "tmp/state_exact_match/panelmatch_ps_vcf_con_Power30.RData"))
...
save(match_cbps_vcf_con_Power30,
     file = file.path(root, "tmp/state_exact_match/panelmatch_cbps_vcf_con_Power30.RData"))
