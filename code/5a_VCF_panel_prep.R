...
setnames(
  df,
  c("forest_cover", "green_cover", "built_cover"),
...
df %>% str
tic()
fwrite(df, file.path(tmp, 'vcf_cell_sample.csv.gz')) # write file for future runs
toc()
